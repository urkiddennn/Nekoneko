  ...
  if (variant === "outline_minimal") {
    return (
      <div className="max-w-4xl mx-auto space-y-24 py-16">
        <h2 className="text-5xl md:text-7xl font-black text-slate-950 dark:text-white uppercase tracking-tighter text-center mb-24 border-b border-slate-950 dark:border-white pb-12">
          {title}
        </h2>
              ...
              <div key={index} className="relative pl-12 pb-24 group last:pb-0">
                ...
                <div className="space-y-6">
                  <div className="flex flex-col md:flex-row md:items-baseline justify-between gap-2 border-b border-slate-100 dark:border-slate-800 pb-4">
                    <h3 className="text-2xl md:text-3xl font-black text-slate-950 dark:text-white uppercase tracking-tighter">
                      {job.role}
                    </h3>
                  ...
                  <div className="text-slate-950 dark:text-white font-black uppercase text-xs tracking-widest">
                    {job.company}
                  </div>
                  <p className="text-md font-bold text-slate-500 dark:text-slate-400 leading-relaxed max-w-2xl">
                    {job.description}
                  </p>
                </div>
              </div>
  ...
  if (variant === "brutalist") {
    return (
      <div className="max-w-4xl mx-auto space-y-12 py-12">
        <h2 className="text-4xl md:text-5xl font-black text-slate-950 dark:text-white uppercase italic tracking-tighter text-center mb-16">
          {title}
        </h2>
                ...
                <div className="p-8 space-y-4 flex-1">
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-sm font-black text-slate-950 dark:text-white uppercase tracking-tight">
                          {job.role}
                        </div>
                  ...
                  <div className="text-indigo-600 dark:text-indigo-400 font-black uppercase text-xs tracking-widest">
                    {job.company}
                  </div>
                  <p className="text-md font-bold text-slate-900 dark:text-slate-300 leading-relaxed line-clamp-3">
                    {job.description}
                  </p>
                </div>
    ...
    return (
      <section className="py-12">
        <div className="flex items-center gap-3 mb-10">
          <h2 className="text-2xl font-black text-slate-950 dark:text-white uppercase italic tracking-tighter">
            {title}
          </h2>
        </div>
            ...
            return (
              <div key={index} className="relative">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-slate-950 dark:text-slate-400 text-sm leading-relaxed max-w-2xl">
                    {job.description}
                  </p>
                </div>
              </div>
  ...
  if (variant === "glassmorphism") {
    return (
      <section className="py-12">
        ...
        <div className="relative space-y-12  border-gray-100 dark:border-slate-800 ml-4">
          {jobs.map((job, index) => {
            return (
              <div
                key={index}
                className="relative p-2  bg-gray-200 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20 border border-gray-100
"
              >
                <div className="space-y-1">
                  <div className="flex items-center gap-3">
          ...
          <div className="md:w-1/3">
            <div className="sticky top-12">
              ...
              <p className="text-slate-900 dark:text-slate-400 font-medium text-lg leading-relaxed">
                A timeline of my professional journey and contributions to the
                tech industry.
              </p>
            </div>
          </div>
                  ...
                  <div key={index} className="relative pl-24 md:pl-24 group">
                    <div className="bg-white dark:bg-slate-900/50 p-6 md:p-8 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-[0_5px_40px_-10px_rgba(0,0,0,0.05)] hover:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] transition-all">
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4">
                        <h3 className="text-lg md:text-xl font-bold text-slate-950 dark:text-white">
                          {job.role}
                        </h3>
                      ...
                      <div
                        className="text-indigo-600 font-bold mb-4 uppercase tracking-wide text-sm"
                        style={{ color: primaryColor }}
                      >
                        {job.company}
                      </div>
