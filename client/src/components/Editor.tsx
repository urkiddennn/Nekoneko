            ...
            <div className="flex-1 flex overflow-hidden">
                ...
                <div className="w-14 border-r border-gray-200 bg-white flex flex-col items-center py-6 gap-6 shrink-0 z-30">
                    ...
                    <button
                        ...
                        className="p-2 rounded transition-colors text-gray-400 hover:text-gray-900"
                            ...
                            <div className="h-full bg-gray-50 overflow-y-auto relative no-scrollbar cursor-default">
                                ...
                                <div className="absolute top-4 right-4 z-10 flex items-center gap-2 bg-white border border-gray-200 rounded-lg shadow-sm p-1">
                                    <button
                                        ...
                                        className={`p-1.5 rounded transition-colors select-none ${viewportWidth === 375 ? 'bg-gray-900 text-white' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'
                                            }`}
                                        title="Mobile (375px)"
                                    >
                                        <Smartphone size={16} />
                                    ...
                                    <button
                                        ...
                                        className={`p-1.5 rounded transition-colors select-none ${viewportWidth === 768 ? 'bg-gray-900 text-white' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'
                                            }`}
                                        title="Tablet (768px)"
                                    >
                                        <Tablet size={16} />
                                    ...
                                    <button
                                        ...
                                        className={`p-1.5 rounded transition-colors select-none ${viewportWidth === 'full' ? 'bg-gray-900 text-white' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'
                                            }`}
