...
const Skills: React.FC<SkillsProps> = ({ title, skills, barColor }) => {
            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    <div className="w-24 h-1.5 bg-slate-200 mx-auto rounded-full overflow-hidden">
                        <div className="h-full rounded-full w-1/2 mx-auto" style={{ backgroundColor: primaryColor }}></div>
                    </div>
                </div>
                        ...
                        return (
                            <div key={index} className="group">
                                <div className="flex justify-between items-end mb-2">
                                    <span className="text-lg font-bold text-slate-700 uppercase tracking-wider">{skill.name}</span>
                                    <span className="text-sm font-black text-slate-400 group-hover:text-indigo-600 transition-colors" style={{ color: effectiveColor }}>{skill.level}%</span>
                                </div>
